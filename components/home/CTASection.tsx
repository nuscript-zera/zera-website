...
export default function CTASection() {
  return (
    <section id="demo" className="max-lg:pt-[5.3125rem] lg:pt-[7.5rem] max-lg:pb-[3.5rem] lg:pb-[5rem]" style={{ backgroundColor: "#0f172a" }}>
      <div className="max-w-[60rem] mx-auto px-4 md:px-[1.5938rem] lg:px-[2.125rem] text-center">
        <AnimatedSection>
          <h2 className="font-bold leading-[0.95] tracking-[-0.02em] text-balance text-white text-[2.4rem] lg:text-[3.2rem]">
            See a single encounter go end to end.
          </h2>
          <p className="mt-5 mx-auto max-w-[40rem] text-lg lg:text-xl leading-relaxed text-white/70">
            Watch Zera turn one ophthalmology encounter into a documented, coded,
            validated, claim-ready record — in real time, in one workflow.
          </p>
